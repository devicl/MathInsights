...
#trying interactions
glm(sum_deaths ~ log(Unemployed) + Median.Household.Income. + County + sum_patcount_opioid + log(Number.in.Poverty) + Year + log(Unemployed)*County + Median.Household.Income.*County + Year*County + sum_patcount_opioid*County + log(Number.in.Poverty)*County, data = clean_mega_data, family = "poisson") |>
  tidy()
```
...
clean_mega_data_location_20 <- inner_join(clean_mega_data_20, ca_counties, by = "County")
clean_mega_data_location_21 <- inner_join(clean_mega_data_21, ca_counties, by = "County")
clean_mega_data_location_22 <- inner_join(clean_mega_data_22, ca_counties, by = "County")
clean_mega_data_location_23 <- inner_join(clean_mega_data_23, ca_counties, by = "County")
